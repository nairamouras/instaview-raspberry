...
import os
import concatenacao_instagram_git
...
def cria_clipes():
    ...
    if qtd_imagens_git > 0 and qtd_imagens_insta > 0:
        ...
        clipes_imagens_git = [ImageClip(n).set_duration(tempo_git) for n in images_list_git] 
        ...
        concatenacao_instagram_git.concatenacao_clipes('clipe_imagens_insta.mp4', 'clipe_imagens_git.mp4')
    ...
    #Se houver apenas imagens do GitHub
        ...
        concatenacao_instagram_git.concatenacao_clipes(None, 'clipe_imagens_git.mp4')
    ...
    #Se houver apenas imagens do Instagram
        ...
        concatenacao_instagram_git.concatenacao_clipes('clipe_imagens_insta.mp4', None)